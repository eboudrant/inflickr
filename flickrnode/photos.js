...
Photos.prototype.getRecent = function(arguments, callback) {
    this._request.executeRequest("flickr.photos.getRecent", arguments, false, null, callback);
};

Photos.prototype.recentlyUpdated = function(arguments, callback) {
    this._request.executeRequest("flickr.photos.recentlyUpdated", arguments, false, null, callback);
};
